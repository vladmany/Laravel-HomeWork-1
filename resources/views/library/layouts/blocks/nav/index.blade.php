                ...
                @else
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('userpanel.books.index') }}">Мои книги</a>
                            <a class="dropdown-item" href="{{ route('userpanel.profile') }}">Мой аккаунт</a>
                            @if(Auth::user()->role_id == 2)
                                <hr>
                                <a class="dropdown-item menu-admin-font" href="{{ route('adminpanel.users.index') }}">Управление пользователями</a>
                                <a class="dropdown-item menu-admin-font" href="{{ route('adminpanel.genres.index') }}">Управление жанрами</a>
                                <a class="dropdown-item menu-admin-font" href="{{ route('adminpanel.books.index') }}">Управление книгами</a>
